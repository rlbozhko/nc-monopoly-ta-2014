...
public class TestGameController {
	...
	@RequestMapping(value = "/test_game.action", method = RequestMethod.GET)
	public ModelAndView getLogin(@CookieValue(value = "bb_data", required = false) String hash) {

		ModelAndView mav = new ModelAndView("test_game");
	...
	@RequestMapping(value = "/test_game.action", method = RequestMethod.GET, params = { "actionType" })
	public ModelAndView clickAction(@CookieValue(value = "bb_data", required = false) String hash,
			@RequestParam String actionType) {
		ModelAndView mav = new ModelAndView("redirect:test_game.action");
	...
	@RequestMapping(value = "/test_game.action", method = RequestMethod.GET, params = "selectedPlayerName")
	...
	@RequestMapping(value = "/test_game.action", method = RequestMethod.GET, params = { "dealTargetName"})
